                                    ...
                                    <div
                                        ...
                                        <div class="product_content">
                                            ...
                                            <div class="product_name">
                                                <div><a href="product.html">{{ Str::words($product->name, 3, '') }}</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div
                                            ...
                                            <div class="product_content">
                                                ...
                                                <div class="product_name">
                                                    <div><a
                                                            href="product.html">{{ Str::words($product->name, 3, '') }}</a>
                                                    </div>
                                                </div>
                                                <div class="product_extras">
                                                    <div class="product_color">
                        ...
                        <div class="col-lg-3">
                            <div class="arrivals_single clearfix">
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    <div class="arrivals_single_image"><img src="frontend/images/new_single.png" alt="">
                                    </div>
                    ...
                    <div class="owl-carousel owl-theme reviews_slider">
                        ...
                        <div class="owl-item">
                            <div class="review d-flex flex-row align-items-start justify-content-start">
                                <div>
                                    <div class="review_image"><img src="frontend/images/review_1.jpg" alt=""></div>
                                </div>
                        ...
                        <div class="owl-item">
                            <div class="review d-flex flex-row align-items-start justify-content-start">
                                <div>
                                    <div class="review_image"><img src="frontend/images/review_2.jpg" alt=""></div>
                                </div>
                                <div class="review_content">
                        ...
                        <div class="owl-item">
                            <div class="review d-flex flex-row align-items-start justify-content-start">
                                <div>
                                    <div class="review_image"><img src="frontend/images/review_3.jpg" alt=""></div>
                                </div>
                                <div class="review_content">
