<template>
  <form @submit.prevent="getMode ?patchOption() : createOption()">
    <div class="card-body">
      <div class="form-group">
        <label for="inputName">Label</label>
        <input
          type="text"
          v-model="getSingleOption.label"
          id="inputName"
          class="form-control"
...
export default {
  ...
  methods: {
    ...mapActions(["storeOption", "updateOption", "setError"]),
    createOption() {
      this.getSingleOption.attribute_id = this.$route.params.id;
      this.storeOption(this.getSingleOption);
    },
    patchOption() {
      this.updateOption(this.getSingleOption);
    }
  },
  watch: {
    getSingleOption: {
  ...
  computed: mapGetters(["getSingleOption", "getMode", "hasError"])
};
</script>
